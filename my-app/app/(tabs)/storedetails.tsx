...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 22, fontWeight: 'bold', marginLeft: 10, color: '#C7E62B' },
  storeName: { fontSize: 22, fontWeight: '700', marginBottom: 5 },
  ...
  button: { flex: 1, paddingVertical: 10, borderRadius: 8, alignItems: 'center', marginHorizontal: 4, marginBottom: 20 },
